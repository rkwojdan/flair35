...
class Plotter(object):
    ...
    def plot_learning_rate(self,
        ...
        losses = losses[skip_first:-
                        skip_last] if skip_last > 0 else losses[skip_first:]
